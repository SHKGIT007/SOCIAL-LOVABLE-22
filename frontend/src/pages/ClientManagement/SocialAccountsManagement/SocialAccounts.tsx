                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="bg-white border-gray-200 shadow-sm focus-visible:ring-indigo-500 pr-10"
                      />
                      <button
                        type="button"
                      ...
                      >
                        {showFbSecret ? <EyeOff size={18} /> : <Eye size={18} />}
                      </button>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="bg-white border-gray-200 shadow-sm focus-visible:ring-pink-500 pr-10"
                      />
                      <button
                        type="button"
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600"
                      >
                        {showIgSecret ? <EyeOff size={18} /> : <Eye size={18} />}
                      </button>
                    </div>
                  </div>
                </div>
